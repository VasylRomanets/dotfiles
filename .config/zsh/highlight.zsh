...
ZSH_HIGHLIGHT_STYLES[alias]='fg=#7fbbb3,bold'
ZSH_HIGHLIGHT_STYLES[suffix-alias]='fg=#7fbbb3,bold'
ZSH_HIGHLIGHT_STYLES[global-alias]='fg=#7fbbb3,bold'
ZSH_HIGHLIGHT_STYLES[builtin]='fg=#7fbbb3,bold'
ZSH_HIGHLIGHT_STYLES[function]='fg=#7fbbb3,bold'
ZSH_HIGHLIGHT_STYLES[command]='fg=#7fbbb3,bold'
ZSH_HIGHLIGHT_STYLES[precommand]='fg=#7fbbb3,italic'
...
ZSH_HIGHLIGHT_STYLES[path_pathseparator]='fg=#a7c080'
...
ZSH_HIGHLIGHT_STYLES[back-double-quoted-argument]='fg=#a7c080'
ZSH_HIGHLIGHT_STYLES[back-dollar-quoted-argument]='fg=#a7c080'
